...
@onready var volume_slider = $CenterContainer/PanelContainer/VBoxContainer/VolumeSlider
@onready var display_mode_button = $CenterContainer/PanelContainer/VBoxContainer/DisplayModeButton
@onready var display_mode_label = $CenterContainer/PanelContainer/VBoxContainer/DisplayModeLabel
